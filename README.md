...
You can place the brand image files in the repository root or in an `assets/` folder. The app auto-detects the first matching file from these names (from either the repo root or `assets/`, with or without URL-encoded spaces):
